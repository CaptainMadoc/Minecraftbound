...
function _GBDEBUG:init()
    self:createLocMsg("minecraftDebugCall", function(name) return self:callTestUnit(name) end)
    self:createLocMsg("minecraftDebugGetUnits", function() return self:getTestUnits()  end)
end
